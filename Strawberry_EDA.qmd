...
table1 <- extract_tables(
  file = "Rajveer Kaur, et al.pdf", 
  pages = 1891,                     
  area = list(c(72, 72, 540, 790)), 
  method = "stream",                
  guess = FALSE,                   
  output = "tibble")
```
This chunk should extract a pdf with Classification of pesticides using in strawberries. However, due to the version of my Mac, it doesn't show up.
